...
class App extends Application {
    ...
    async start() {
        ...
        //await this.loader.load('../../common/models/carRoad/carRoad.gltf');
        await this.loader.load('../../common/models/carRoad2/carRoad2.gltf');
        
        //await this.loader.load('../../common/models/onlyCar/onlyCar.gltf');
       ...
       //model.rotation.x += 30;
        ...
        this.camera.translation = vec3.fromValues(-0.25, 3, 7); //0,3,6
